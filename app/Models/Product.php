    ...
    public static function best($type) {
        switch ($type) {
            ...
            default:
                ...
                $img = "bastion-1.jpg";
                $text = "Белый список для корпоративных приложений, серый список для опасных приложений, чёрный список для вредоносных программ
                        <ul>
    ...
    public static function trust($type) {
        switch ($type) {
            ...
            case 2:
                $title = "МИД";
                $img = "pro-6.png";
                $text = "Выберите один из множества механизмов многофакторной аутентификации в соответствии с конкретными требованиями различных групп населения, поскольку не существует универсального решения MFA для всех.
                        <ul>
