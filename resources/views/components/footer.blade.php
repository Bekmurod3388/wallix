<footer class="footer">
    <div class="container">
        <div class="footer__body">
            <div class="footer__item">
                <ul class="footer__phones">
                    <li>+7 727 355 30 31</li>
                    <li>+7 727 355 30 32</li>
                    <li>+7 727 355 30 34</li>
                    <li>+7 727 355 30 36</li>
                </ul>
                <a href="mailto:wallix@abrisdc.com" class="footer__email">wallix@abrisdc.com</a>
        ...
        <span class="footer__rights">© 2021. Все права защищены.</span>
    </div>
</footer>
